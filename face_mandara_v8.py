        ...
        while True:
            ...
            while True:
                ...
                for i in range(len(similar_windows)):
                    print("time",similar_windows[i].time)
                    if  i == 0:
                        x = easing.ease_in_out_circular(similar_windows[i].time, frame.shape[1]/2-100, 0, end_frame_num)
                        y = easing.ease_in_out_circular(similar_windows[i].time, frame.shape[0]/2-100, 250, end_frame_num)
                    elif i == 1:
                        x = easing.ease_in_out_circular(similar_windows[i].time, frame.shape[1]/2-100, 300, end_frame_num)
                        y = easing.ease_in_out_circular(similar_windows[i].time, frame.shape[0]/2-100, 0, end_frame_num)
                    elif i == 2:
                        x = easing.ease_in_out_circular(similar_windows[i].time, frame.shape[1]/2-100, 300, end_frame_num)
                        y = easing.ease_in_out_circular(similar_windows[i].time, frame.shape[0]/2-100, -250, end_frame_num)
                    elif i == 3:
