                    ...
                    for j in reversed(range(len(similar_windows[i]))):
                        ...
                        try:
                            if j<3:
                                ...
                                d = distance[0][j]
                                print("d:{}".format(d))
                                draw.text((int(x-radius*1.5+1), y+radius+1), str(round((1-d)*100, 5))+"%", font=font, fill=(0,0,0,128))
                                draw.text((int(x-radius*1.5+1), y+radius-1), str(round((1-d)*100, 5))+"%", font=font, fill=(0,0,0,128))
                                draw.text((int(x-radius*1.5+1), y+radius), str(round((1-d)*100, 5))+"%", font=font, fill=(0,0,0,128))
                                draw.text((int(x-radius*1.5-1), y+radius+1), str(round((1-d)*100, 5))+"%", font=font, fill=(0,0,0,128))
                                draw.text((int(x-radius*1.5-1), y+radius-1), str(round((1-d)*100, 5))+"%", font=font, fill=(0,0,0,128))
                                draw.text((int(x-radius*1.5-1), y+radius), str(round((1-d)*100, 5))+"%", font=font, fill=(0,0,0,128))
                                draw.text((int(x-radius*1.5), y+radius+1), str(round((1-d)*100, 5))+"%", font=font, fill=(0,0,0,128))
                                draw.text((int(x-radius*1.5), y+radius-1), str(round((1-d)*100, 5))+"%", font=font, fill=(0,0,0,128))
                                draw.text((int(x-radius*1.5), y+radius), str(round((1-d)*100, 5))+"%", font=font, fill=(255,255,255,128))
                        except:
