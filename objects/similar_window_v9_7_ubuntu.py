...
class SimilarWindow:
    ...
    def _num_ride(self, image, num):
        ...
        print("in _num_ride")
        try:
            draw.text((w*(1/2)+self.similar_num*2+1, h*(2/3)+self.similar_num*2), "No. "+str(text), font=font, fill=(0,0,0,128))
            draw.text((w*(1/2)+self.similar_num*2-1, h*(2/3)+self.similar_num*2), "No. "+str(text), font=font, fill=(0,0,0,128))
            draw.text((w*(1/2)+self.similar_num*2, h*(2/3)+self.similar_num*2+1), "No. "+str(text), font=font, fill=(0,0,0,128))
            draw.text((w*(1/2)+self.similar_num*2, h*(2/3)+self.similar_num*2-1), "No. "+str(text), font=font, fill=(0,0,0,128))
            draw.text((w*(1/2)+self.similar_num*2+1, h*(2/3)+self.similar_num*2+1), "No. "+str(text), font=font, fill=(0,0,0,128))
            draw.text((w*(1/2)+self.similar_num*2+1, h*(2/3)+self.similar_num*2-1), "No. "+str(text), font=font, fill=(0,0,0,128))
            draw.text((w*(1/2)+self.similar_num*2-1, h*(2/3)+self.similar_num*2+1), "No. "+str(text), font=font, fill=(0,0,0,128))
            draw.text((w*(1/2)+self.similar_num*2-1, h*(2/3)+self.similar_num*2-1), "No. "+str(text), font=font, fill=(0,0,0,128))
            draw.text((w*(1/2)+self.similar_num*2, h*(2/3)+self.similar_num*2), "No. "+str(text), font=font, fill=(255,255,255,128))
