...
import easing
from objects import face_frame, similar_window_v5, line
        ...
        while True:
            ...
            for i in range(len(face_rect_manager)):
                ...
                for j in range(len(all_images[i])):
                    sw = similar_window_v5.SimilarWindow(distance=distance_no1, place=[0, 0], image=all_images[i][j], similar_num=len(all_images[i])-j)
            ...
            while True:
                ...
                for i in range(len(similar_windows)):
                    ...
                    for j in range(len(similar_windows[i])):
                        ...
                        similar_windows[i][j].put_on_frame(frame=frame, place=[int(y), int(x)])
