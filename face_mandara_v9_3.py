...
from objects import similar_window_v7, line_v3
            ...
            for i in range(len(face_rect_manager)):
                ...
                for j in range(len(all_images[i])):
                    ...
                    # 真右
                        ...
                        amount_movement_x = random.randint(-300, 300)
                        amount_movement_y = random.randint(100, 250)

                    sw = similar_window_v7.SimilarWindow(distance=distance_no1, \
